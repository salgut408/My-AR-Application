...
class DepthSettings {
    val SHARED_PREFERENCES_ID: String = "SHARED_PREFERENCES_OCCLUSION_OPTIONS"
    val SHARED_PREFERENCES_SHOW_DEPTH_ENABLE_DIALOG_OOBE: String = "show_depth_enable_dialog_oobe"
    val SHARED_PREFERENCES_USE_DEPTH_FOR_OCCLUSION: String = "use_depth_for_occlusion"
